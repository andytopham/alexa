...
class Mybeebotte():
	def __init__(self, interval = DEFAULT_INTERVAL, no_sensors = 1):
		...
		try:
			...
			self.logger.info('Beebotte channel: '+keys.beebotte_channel+' variables: '+keys.beebotte_variable)
			print 'Beebotte channel: ',keys.beebotte_channel,' variables: ',keys.beebotte_variable
		except:
